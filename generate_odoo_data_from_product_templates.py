...
from product_templates import product_template_rf30_lite_simple, product_template_rf30_lite_doble
...
if __name__ == "__main__":
    templates = [product_template_rf30_lite_simple, product_template_rf30_lite_doble]
