...
from attributes import PriceMultiplierPuertaSimpleWidth, PriceMultiplierPuertaSimpleHeight
from attributes import PriceMultiplierPuertaDobleWidth, PriceMultiplierPuertaDobleHeight
...
price_mutiplier_mixin_puerta_simple_width = PriceMultiplierPuertaSimpleWidth.to_attribute_config_mixin()
price_mutiplier_mixin_puerta_simple_height = PriceMultiplierPuertaSimpleHeight.to_attribute_config_mixin()

price_multiplier_mixin_puerta_doble_width = PriceMultiplierPuertaDobleWidth.to_attribute_config_mixin()
price_mutiplier_mixin_puerta_doble_height = PriceMultiplierPuertaDobleHeight.to_attribute_config_mixin()

attributes_puerta_simple = [width_mixin_puerta_simple, height_mixin, acabado_mixin, marco_mixin, grampa_mixin, sentido_mixin, price_mutiplier_mixin_puerta_simple_width, price_mutiplier_mixin_puerta_simple_height]
attributes_puerta_doble = [width_mixin_hoja_activa_puerta_doble, width_mixin_hoja_pasiva_puerta_doble, height_mixin, acabado_mixin, marco_mixin, grampa_mixin, hoja_activa_mixin, price_multiplier_mixin_puerta_doble_width, price_mutiplier_mixin_puerta_doble_height]
